...
describe('Store', () => {
  ...
  it('should handle setSearchTerm actions', () => {
    const state = rootReducer({searchTerm: 'some string'}, {type: 'setSearchTerm', value: 'new string'})
    expect(state).to.deep.equal({searchTerm: 'new string'})
  })
})
// store.dispatch() for testing result of actions
